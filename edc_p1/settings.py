"""
Django settings for edc_p1 project.
...
SECRET_KEY = '5um&hwv(*($($1#ng953tisy@egm0-(+=u2h2nq*50ikjw@%y9'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['38c96d7c.ngrok.io', 'localhost', '127.0.0.1']
...
WSGI_APPLICATION = 'edc_p1.wsgi.application'
